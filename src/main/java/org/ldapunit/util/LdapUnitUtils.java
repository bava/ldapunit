...
public class LdapUnitUtils {
	...
	public static void loadData(Resource ldifFile, String port) throws Exception
	{		
		DirContext ctx = null;
		try {			
			Properties environment = new Properties();
			environment.setProperty(DirContext.INITIAL_CONTEXT_FACTORY, "com.sun.jndi.ldap.LdapCtxFactory");
			environment.setProperty(DirContext.PROVIDER_URL, String.format("ldap://localhost:%s", port));
	...
	public static void clearSubContexts(Name name, String port) throws NamingException {
