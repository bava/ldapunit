...
public class ApacheDSConfigurer implements EmbeddedServerConfigurer {
	...
	public void startServer() {
		...
		try {
				System.out.println("Starting Embedded ApacheDS LDAP Server ....");
				...
				System.out.println("Embedded ApacheDS LDAP server has started successfully ....");
			}
			catch(Exception e) {
	...
	public void stopServer() {
		try {
			System.out.println("Shutting down Embedded ApacheDS LDAP Server ....");
			ldapServer.stop();
	        directoryService.shutdown();
	        FileUtils.deleteDirectory( directoryService.getWorkingDirectory() );
	        System.out.println("Embedded ApacheDS LDAP Server shutdown successful ....");
		}
		catch(Exception e) {
			throw new RuntimeException(e);
		}
